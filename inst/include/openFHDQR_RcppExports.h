...
namespace openFHDQR {
    ...
    inline arma::vec update_theta_diff(double gamma, double sigma, arma::mat X, arma::vec beta, arma::vec z, arma::vec y) {
        typedef SEXP(*Ptr_update_theta_diff)(SEXP,SEXP,SEXP,SEXP,SEXP,SEXP);
        static Ptr_update_theta_diff p_update_theta_diff = NULL;
        if (p_update_theta_diff == NULL) {
            validateSignature("arma::vec(*update_theta_diff)(double,double,arma::mat,arma::vec,arma::vec,arma::vec)");
            p_update_theta_diff = (Ptr_update_theta_diff)R_GetCCallable("openFHDQR", "_openFHDQR_update_theta_diff");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_update_theta_diff(Shield<SEXP>(Rcpp::wrap(gamma)), Shield<SEXP>(Rcpp::wrap(sigma)), Shield<SEXP>(Rcpp::wrap(X)), Shield<SEXP>(Rcpp::wrap(beta)), Shield<SEXP>(Rcpp::wrap(z)), Shield<SEXP>(Rcpp::wrap(y)));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (Rcpp::internal::isLongjumpSentinel(rcpp_result_gen))
